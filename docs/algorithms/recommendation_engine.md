...
来源 `data/knowledge_base/technology_library_seed.csv`(项目组按工程实际构建,10 条:固化稳定化、土壤淋洗、植物修复、化学氧化 ISCO、生物修复、热脱附、阻隔填埋、农艺调控、客土换土、有机质改良)。来源字段如实标注为"通用导则/工程经验",非伪造标准条文。字段:适用污染物/土壤/用地/阶段、优点、局限、成本等级、工期等级、二次风险、禁用条件、来源。
